...
function HeroGeometric({
    ...
    title1 = "Elevate Your Business Vision",
            ...
            <div className="relative z-10 container mx-auto pt-4 md:pt-6">
                <div className="max-w-3xl mx-auto text-center">
                    <motion.div
                        ...
                        initial="hidden"
                        animate="visible"
                        className="inline-flex items-center gap-2 px-3 py-1 mb-3 rounded-full bg-white/[0.03] border border-white/[0.08]"
                    >
