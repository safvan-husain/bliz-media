...
const ActionButton = ({ children, href }: { children: React.ReactNode; href?: string }) => (
    <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="mt-8 px-8 py-3 rounded-full bg-primary text-white font-semibold shadow-lg transition-colors hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:ring-opacity-75 inline-block"
    >
        {children}
    </motion.a>
);
