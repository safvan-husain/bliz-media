        ...
        <div ref={containerRef} className="relative w-full h-full bg-[#FAFAFA] overflow-hidden">
            ...
            <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
                ...
                <motion.div
                    ...
                    className="absolute top-[15%] z-10 flex flex-col items-center justify-center text-center px-4"
                >
                    <h2 className="text-4xl md:text-6xl font-black text-gray-900 tracking-tighter mb-6 uppercase">
                        Cinematic Excellence
                    </h2>
                    <p className="text-sm md:text-lg text-gray-600 max-w-2xl leading-relaxed mb-10 font-medium italic">
                        Transforming visions into high-impact media production that captures attention and tells your story with precision.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                        ...
                        <a
                            href="/projects"
                            className="w-full sm:w-auto inline-flex items-center justify-center gap-4 border-2 border-black/10 text-black px-10 py-5 rounded-full font-black tracking-[0.2em] text-xs transition-all duration-500 hover:border-black hover:bg-black hover:text-white active:scale-95 group uppercase"
                        >
                            SEE OUR WORK
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
