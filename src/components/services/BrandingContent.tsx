...
const CONTENT = {
    ...
    cta: {
        title: "Let’s Build Your Brand Identity",
        description: "From logos to full brand guidelines, we help you create a professional and memorable brand that stands out.",
