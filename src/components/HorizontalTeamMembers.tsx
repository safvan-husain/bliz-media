...
export default function HorizontalTeamMembers({ members }: HorizontalTeamMembersProps) {
...
function TeamMemberCard({ member }: { member: TeamMember }) {
    return (
        <div
            className="group relative w-[80vw] md:w-[400px] h-[50vh] md:h-[500px] rounded-[2rem] overflow-hidden shadow-2xl transition-all duration-700 hover:scale-[1.01] flex-shrink-0 cursor-pointer block isolate transform-gpu [backface-visibility:hidden]"
        >
            {/* Background Image */}
