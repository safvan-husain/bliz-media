...
export function WebDevelopmentHero({
  ...
  return (
    <FloatingIconsHero
      ...
      subtitle={
        description ||
        "We design and develop fast, secure, and scalable websites tailored to your business goals — from simple static sites to advanced custom web applications and e-commerce platforms"
      }
      ctaText="START YOUR PROJECT"
      ctaHref={createServiceWhatsAppLink(title)}
      secondaryCtaText="SEE OUR WORK"
      secondaryCtaHref={`/projects?filter=web-development`}
      icons={combinedIcons}
    />
  );
}
